/* ==================================SQL Indexing======================
   1.This script demonstrates various index types in SQL Server including clustered,
...
-- Attempt to create a Unique Index on the Category column in Sales.Products.Note: This may fail if duplicate values exist.
USE SalesDB;
